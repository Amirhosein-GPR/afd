...
//             for asm_inst in subroutine.asm_lines {
...
//             for asm_inst in basic_block.asm_inst_ids {
//                 let inst_type_string = match asm_inst.instruction_type {
//                     InstructionType::Cti(cti_data) => {
//                         let target_adr = match cti_data.target_address {
//                             TargetAddress::Direct(s) => format!("Direct({s})"),
...
//             let start_line = subroutine_caps[2].parse::<usize>().unwrap();
//             let end_line = subroutine_caps[3].parse::<usize>().unwrap();
...
//                 start_line,
//                 end_line,
//                 asm_lines: assembly_instructions,
//                 necessary,
//             });
//         }
...
//                 asm_inst_ids: assembly_instructions,
//                 edges,
//                 subroutine_index,
//             });
//         }
...
// fn capture_assembly_instruction(asm_inst_caps: Captures) -> AssemblyLine {
